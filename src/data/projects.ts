...
// Conteúdo PT — o EN entra numa fase dedicada de i18n.
...
export interface Project {
  ...
  title: string;
  lead: string;
  cover: string;          // caminho relativo a public/ (ex.: images/cv.jpeg)
  coverIsVideo?: boolean;
  rep?: 'hand' | 'nn';    // representação à mão na home (só bandeiras)
  featured: boolean;      // bandeira (destaque grande na home)
  cell: string;           // rótulo da célula na home
...
export const projects: Project[] = [
    ...
    sections: [
      {
        h3: 'A inspiração',
        body: [
          'Entrei na área de Dados justamente por causa da Visão Computacional. Eu ficava impressionado assistindo vídeos de carros autônomos e câmeras inteligentes, tentando entender como as máquinas "enxergavam" o mundo. Decidi tirar um fim de semana pra finalmente colocar a mão na massa naquilo que me trouxe pra essa carreira.',
          'Não queria fazer só um "Hello World". Queria algo com impacto real. Desenvolvi um sistema capaz de identificar o <strong>Sinal de Socorro</strong> (Signal for Help) em tempo real e disparar um alerta silencioso via API. A repercussão rendeu um convite pra <strong>ministrar uma masterclass</strong> de Visão Computacional na TripleTen.',
        ],
      },
      {
        h3: 'Como funciona a lógica',
        body: [
          'Diferente de abordagens que treinam modelos pesados de Deep Learning, este sistema usa <strong>geometria euclidiana</strong> e <strong>álgebra linear</strong> pra analisar a biomecânica da mão em tempo real, só com CPU. Tudo passa por uma <strong>máquina de estados finita (FSM)</strong> pra não confundir um "tchau" com um pedido de socorro:',
      ...
      },
      {
        ...
        body: [
          ...
          '<strong>Espaços de cor:</strong> a clássica dor de cabeça de reverter o BGR nativo do OpenCV pro RGB que os modelos de pose exigem, e devolver as bounding boxes pra tela.',
        ],
      },
    ],
  },

  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          '<strong>A armadilha pacifista (~30M steps perdidos):</strong> uma penalidade de −0.05 por chute errado se acumulava ~100 vezes por episódio (−5 de retorno esperado), engolindo a rara recompensa de gol. O PPO concluiu, matematicamente, que o ótimo era <em>nunca chutar</em> — o agente ia pro canto do campo e ficava parado.',
          '<strong>Esquecimento catastrófico:</strong> num currículo monotônico, o agente mandava bem no estágio 1 (88% de gols), travava no estágio 2 e <em>esquecia o estágio 1</em> (caía pra 4%). É o vale visível perto dos 28M steps na curva de retorno — a rede "desaprendeu" o ataque pra abrir espaço pra defesa.',
          '<strong>Colapso numérico:</strong> com ações contínuas, o bônus de entropia empurrava o desvio-padrão da gaussiana ao infinito até estourar o float32 (NaN, crash). A solução foi estrutural: troquei pra <strong>18 ações discretas</strong> com squashing por tanh.',
        ],
      },
      {
    ...
    sections: [
      {
        ...
        body: [
          ...
          'Removi casos que distorciam tudo: a Mercedes-Benz tinha só 40 linhas (valores repetidos) e mais de 800 carros custavam menos de US$100 — outliers irreais pro mercado.',
        ],
      },
      {
        h3: 'Entendendo outliers (pra qualquer público)',
        body: [
          'Preparei uma explicação simples do que são outliers usando um boxplot (mediana, quartis, extremos). Um caso prático: um Chevrolet levou 271 dias pra vender, enquanto a mediana era 33 — esse único valor puxava a média pra 39,6 dias. Removendo os outliers, a média caiu pra 36,6.',
          'A remoção foi criteriosa: só <strong>3,1% dos dados</strong> saíram, mas eles inflavam a média em quase 10%. Validei as diferenças com testes estatísticos (ANOVA e Tukey\'s HSD via Scipy/Statsmodels) — conclusões baseadas em evidência, não em achismo visual.',
        ],
      },
      {
        h3: 'O modelo',
...

  {
    ...
    title: 'Buraco da Mãe',
    lead: 'Um app que transforma os pontos do nosso jogo de Buraco em análises em tempo real — dashboards dinâmicos e uma celebração a cada partida.',
    ...
    sections: [
      {
        ...
        body: [
          'O projeto nasceu de uma cena do cotidiano: jogar Buraco com a minha mãe. Por muito tempo o placar era anotado no bloco de notas do celular dela — lento e sem nenhuma graça visual. Vi ali a oportunidade perfeita de automatizar e transformar nosso hobby numa experiência interativa.',
        ],
      },
      {
        h3: 'Desenvolvimento',
        body: [
          'Nunca tinha usado a API do Google Sheets, então estudei: descobri o <strong>gspread</strong>, que conecta o app direto a uma planilha como se fosse um banco de dados online. Pra interface usei <strong>Streamlit</strong>, e com <strong>Plotly</strong> transformei números em histórias — evolução de cada jogador, maiores vitórias, sequências, médias.',
          'Implementei cache com <code>@st.cache_data</code> pra deixar tudo rápido, e um formulário protegido por senha pra só jogadores autorizados registrarem resultados. A cada partida nova, os gráficos se atualizam na hora.',
        ],
      },
      {
        h3: 'Impacto emocional',
        body: [
          'A melhor parte: quando uma partida é registrada, o <code>st.balloons</code> solta balões na tela e a minha mãe abre um sorrisão, como se tivesse ganhado um troféu. Não foi o projeto mais técnico que fiz, mas foi de longe o mais divertido — prova de que a tecnologia também serve pra criar memórias e aproximar pessoas.',
        ],
      },
    ],
  },

  {
    ...
    lead: 'Uma secretária virtual para uma nutricionista: atende no WhatsApp 24/7, responde com base nos dados de cada paciente e passa o bastão pra humana quando precisa.',
    ...
    sections: [
      {
        h3: 'O problema',
        body: [
          'Uma nutricionista me procurou: a maior dor dela era o volume de mensagens no WhatsApp. No meio dos atendimentos, as conversas desciam na tela e ficavam sem resposta — pacientes prejudicados e consultas desmarcadas. A ideia era um agente que assumisse o papel de secretária: responder dúvidas, mandar info de dieta e manter o atendimento ativo a qualquer hora.',
        ],
      },
      {
        h3: 'A solução',
        body: [
          'Estruturei uma base no Google Sheets (nome, contato, dieta, observações tipo "paciente bariátrico, evitar X"). Orquestrei tudo no <strong>n8n</strong>, integrando a <strong>Evolution API</strong> (mensagens do WhatsApp) e o <strong>Chatwoot</strong> (onde as conversas se centralizam).',
